...
<body>
	...
	<div class="container" style="padding-top: 10px;">
		<h3>Update User</h3>
		<hr><form method="post"name="createUser" action="<?php echo base_url().'index.php/user/edit'.$user['user_id'];?>">
		<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						<label>Email</label>
						<input type="text" value="<?php echo set_value('email',$user['email']);?>" name="email" class="form-control">
